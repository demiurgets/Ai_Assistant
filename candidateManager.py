...
class CandidateManager:
    ...
    def update_candidate(self, candidate_id, data):
        try:
            ...
            update_query = """
                  SET first_name = %s, last_name = %s, email = %s, phone = %s, age = %s, location = %s, 

                    enrollment_start_timestamp = %s, enrollment_end_timestamp = %s, date_created = %s, date_updated = %s

                 WHERE id = %s

                  RETURNING id, first_name, last_name, email, phone, age, address, enrollment_start_timestamp, enrollment_end_timestamp, date_created, date_updated;
    ...
    def get_all_candidates(self):
        ...
        self.cursor.execute('SELECT first_name, last_name, email, phone, age, address, enrollment_start_timestamp, enrollment_end_timestamp, date_created, date_updated FROM candidates')
    ...
    def especific_candidate(self, candidate_id):
        ...
        query = 'SELECT first_name, last_name, email, phone, age, address, enrollment_start_timestamp, enrollment_end_timestamp, date_created, date_updated FROM candidates WHERE id = %s'
