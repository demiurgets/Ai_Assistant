...
if excel_files:
    ...
    #########
    df.drop(columns="Working hours", inplace=True)

    new_column_names = ['name', 'job_type', 'location_type', 'description', 'salary_range', 'salary_currency', 'salary_period', 'key_responsibilities', 'qualifications', 'benefits']
